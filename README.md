...
The server uses OpenRouter at `https://openrouter.ai/api/v1`.
...
- Browser runtime inspection, if added later, should use Chrome DevTools Protocol against browser instances, not an AI provider search tool.
